<div class="not-just-app">
    <div class="description">
        <h1 class="title">It’s not just an app</h1>
        <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
    </div>
    <div class="feature social">
        <h2>Social</h2>
        <svg width="65px" height="7px" viewBox="-2 78 65 7" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
